    ...
    gotoLbl: {
        lbl: [
            expectInterpret("2: ? -> A: Lbl 6", new Context(), [
                new PromptEvent(new Context({ variables: new Variables({ Ans: 2 }) }), "A", 3),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 2, A: 3 }) }), "Lbl 6", 3, false),
                new PromptEvent(new Context({ variables: new Variables({ Ans: 2, A: 3 }) }), "A", 5),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 2, A: 5 }) }), "Lbl 6", 5, false),
            ]),
            expectInterpret("2: ? -> A: Lbl 6:", new Context(), [
                new PromptEvent(new Context({ variables: new Variables({ Ans: 2 }) }), "A", 3),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 2, A: 3 }) }), "Lbl 6", 3, false),
            ...
            expectInterpret("2: ? -> A: Lbl 6 disp", new Context(), [
                new PromptEvent(new Context({ variables: new Variables({ Ans: 2 }) }), "A", 3),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 2, A: 3 }) }), "Lbl 6", 3, true),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 2, A: 3 }) }), "", 3, false),
                new PromptEvent(new Context({ variables: new Variables({ Ans: 2, A: 3 }) }), "A", 5),
            ]),
            expectInterpret("Lbl 0", new Context(), [ new DisplayEvent(new Context(), "Lbl 0", 0, false) ]),
            expectInterpret("Lbl 9", new Context(), [ new DisplayEvent(new Context(), "Lbl 9", 0, false) ]),
            expectInterpret("Lbl .", new Context(), [ new RuntimeErrorEvent(new Context(), RuntimeArgumentError, 1) ]),
            expectInterpret("Lbl 10", new Context(), [ new RuntimeErrorEvent(new Context(), RuntimeArgumentError, 2) ]),
            expectInterpret("Lbl 01", new Context(), [ new RuntimeErrorEvent(new Context(), RuntimeArgumentError, 2) ]),
            expectInterpret("Lbl 1+2", new Context(), [ new RuntimeErrorEvent(new Context(), RuntimeArgumentError, 2) ]),
            expectInterpret("Lbl sqrt(5", new Context(), [ new RuntimeErrorEvent(new Context(), RuntimeArgumentError, 1) ]),
            expectInterpret("Lbl Lbl ", new Context(), [ new RuntimeErrorEvent(new Context(), RuntimeArgumentError, 1) ]),
            expectInterpret("Lbl FreqOn", new Context(), [ new RuntimeErrorEvent(new Context(), RuntimeArgumentError, 1) ]),
            expectInterpret("Lbl 2^2", new Context(), [ new RuntimeErrorEvent(new Context(), RuntimeArgumentError, 2) ]),
            expectInterpret("Lbl 2?", new Context(), [ new RuntimeErrorEvent(new Context(), RuntimeArgumentError, 2) ]),
        ],
        goto: [
            expectInterpret("2: ? -> A: Goto 6", new Context(), [
                new PromptEvent(new Context({ variables: new Variables({ Ans: 2 }) }), "A", 3),
                new RuntimeErrorEvent(new Context({ variables: new Variables({ Ans: 2, A: 3 }) }), RuntimeGotoError, 7),
            ]),
            expectInterpret("2: ? -> A: Goto 6:", new Context(), [
                new PromptEvent(new Context({ variables: new Variables({ Ans: 2 }) }), "A", 3),
                new RuntimeErrorEvent(new Context({ variables: new Variables({ Ans: 2, A: 3 }) }), RuntimeGotoError, 7),
            ...
            expectInterpret("2: ? -> A: Goto 6 disp", new Context(), [
                new PromptEvent(new Context({ variables: new Variables({ Ans: 2 }) }), "A", 3),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 2, A: 3 }) }), "Goto 6", 3, true),
                new RuntimeErrorEvent(new Context({ variables: new Variables({ Ans: 2, A: 3 }) }), RuntimeGotoError, 7),
            ]),
            expectInterpret("Goto 0", new Context(), [ new RuntimeErrorEvent(new Context(), RuntimeGotoError, 1) ]),
            expectInterpret("Goto 9", new Context(), [ new RuntimeErrorEvent(new Context(), RuntimeGotoError, 1) ]),
            expectInterpret("Goto .", new Context(), [ new RuntimeErrorEvent(new Context(), RuntimeArgumentError, 1) ]),
            expectInterpret("Goto 10", new Context(), [ new RuntimeErrorEvent(new Context(), RuntimeArgumentError, 2) ]),
            expectInterpret("Goto 01", new Context(), [ new RuntimeErrorEvent(new Context(), RuntimeArgumentError, 2) ]),
            expectInterpret("Goto 1+2", new Context(), [ new RuntimeErrorEvent(new Context(), RuntimeArgumentError, 2) ]),
            expectInterpret("Goto sqrt(5", new Context(), [ new RuntimeErrorEvent(new Context(), RuntimeArgumentError, 1) ]),
            expectInterpret("Goto Lbl ", new Context(), [ new RuntimeErrorEvent(new Context(), RuntimeArgumentError, 1) ]),
            expectInterpret("Goto FreqOn", new Context(), [ new RuntimeErrorEvent(new Context(), RuntimeArgumentError, 1) ]),
            expectInterpret("Goto 2^2", new Context(), [ new RuntimeErrorEvent(new Context(), RuntimeArgumentError, 2) ]),
            expectInterpret("Goto 2?", new Context(), [ new RuntimeErrorEvent(new Context(), RuntimeArgumentError, 2) ]),
        ],
        jumping: [
            expectInterpret("4*5: Lbl 3 disp Ans + 2: Goto 3", new Context(), [
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 20 }) }), "Lbl 3", 20, true),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 22 }) }), "Lbl 3", 22, true),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 24 }) }), "Lbl 3", 24, true),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 26 }) }), "Lbl 3", 26, true),
            ]),
            expectInterpret("4*5: Goto 3: Ans + 2: Lbl 3", new Context(), [
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 20 }) }), "Lbl 3", 20, false),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 20 }) }), "Lbl 3", 20, false),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 20 }) }), "Lbl 3", 20, false),
            ]),
            expectInterpret("5 -> A: Lbl 2: A-1 => Goto 2 disp", new Context(), [
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 4, A: 5 }) }), "A-1 => Goto 2", 4, true),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 4, A: 5 }) }), "A-1 => Goto 2", 4, true),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 4, A: 5 }) }), "A-1 => Goto 2", 4, true),
            ]),
            expectInterpret("5 -> A: Lbl 2: A-1 -> A disp A => Goto 2: ", new Context(), [
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 4, A: 4 }) }), "A-1 -> A", 4, true),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 3, A: 3 }) }), "A-1 -> A", 3, true),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 2, A: 2 }) }), "A-1 -> A", 2, true),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 1, A: 1 }) }), "A-1 -> A", 1, true),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 0, A: 0 }) }), "A-1 -> A", 0, true),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 0, A: 0 }) }), "A => Goto 2", 0, false),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 4, A: 4 }) }), "A-1 -> A", 4, true),
            ]),
            expectInterpret("9 => Lbl 1 disp 10 disp Lbl 1: 11 disp Goto 1: 12", new Context(), [
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 9 }) }), "9 => Lbl 1", 9, true),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 10 }) }), "10", 10, true),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 11 }) }), "11", 11, true),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 11 }) }), "Lbl 1", 11, true),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 10 }) }), "10", 10, true),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 11 }) }), "11", 11, true),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 11 }) }), "Lbl 1", 11, true),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 10 }) }), "10", 10, true),
            ...
            expectInterpret("9 => Lbl 19 disp 10 disp Lbl 1: 11 disp Goto 1: 12", new Context(), [
                new RuntimeErrorEvent(new Context({ variables: new Variables({ Ans: 9 }) }), RuntimeArgumentError, 4),
            ]),
            ...
            expectInterpret("0 => Lbl 19 disp 10 disp Lbl 1: 11 disp Goto 1: 12", new Context(), [
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 10 }) }), "10", 10, true),
                new DisplayEvent(new Context({ variables: new Variables({ Ans: 11 }) }), "11", 11, true),
                new RuntimeErrorEvent(new Context({ variables: new Variables({ Ans: 11 }) }), RuntimeArgumentError, 4),
            ]),
            ...
            expectInterpret("0 disp Goto 7: 1 disp Lbl 8: 2 disp Lbl 7: 3 disp Goto 8: 4", new Context(), [
                new DisplayEvent(null, "0", 0, true),
                new DisplayEvent(null, "3", 3, true),
                new DisplayEvent(null, "2", 2, true),
                new DisplayEvent(null, "3", 3, true),
                new DisplayEvent(null, "2", 2, true),
                new DisplayEvent(null, "3", 3, true),
                new DisplayEvent(null, "2", 2, true),
